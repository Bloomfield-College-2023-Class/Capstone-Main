...
const Admin = () => {
  ...
  const deleteCar = async () => {
    try {
      const response = await axios.delete(`${BASE_URL}/deleteCar`, {
        data: {
          carID: selectedCar.carID,
        },
      });
  ...
  const deleteNots = async () => {
    try {
      const response = await axios.delete(`${BASE_URL}/deleteNotification`, {
        data: { id: selectedNotification.notificationID },
      });
      alert("delete successful");
      fillNots();
    } catch (error) {
  ...
  const deleteParkedCars = async () => {
    try {
      const response = await axios.delete(`${BASE_URL}/deletePark`, {
        data: {
          recordID: selectedParkedCar.recordID,
        },
      });
  ...
  const deleteTags = async () => {
    try {
      const response = await axios.delete(`${BASE_URL}/deleteTag`, {
        data: {
          tagID: selectedTag.tagID,
        },
      });
  ...
  const deleteCard = async () => {
    try {
      const response = await axios.delete(`${BASE_URL}/deleteCard`, {
        data: {
          rfid: selectedCard.rfid,
        },
      });
  ...
  return (
    <Container maxWidth="md">
      ...
      <Button
        variant="contained"
        color="primary"
        onClick={() => setIsLotsOpen(!isLotsOpen)}
      >
        Lots
      </Button>
                  ...
                  <TableRow>
                    <TableCell>
                      <TextField
                        type="text"
                        className="input"
                        value={selectedLot.parkingLotID}
                        onChange={(e) =>
                          setSelectedLot({
                            ...selectedLot,
                    ...
                    <TableCell>
                      <TextField
                        type="text"
                        className="input"
                        value={selectedLot.numberOfSpots}
                        onChange={(e) =>
                          setSelectedLot({
                            ...selectedLot,
      ...
      <Button
        variant="contained"
        color="primary"
        onClick={() => setIsParkedOpen(!isParkedOpen)}
      >
        Parked Cars
      </Button>
                ...
                {parkedCarsList ? (
                  parkedCarsList.map((parked) => (
                    <TableRow key={parked.recordID}>
                      ...
                      <TableCell>
                        <Button
                          onClick={() => handleParkedClick(parked)}
                          variant="contained"
                          color="primary"
                        >
                          Select
                  ...
                  <TableRow>
                    <TableCell>
                      <TextField
                        type="text"
                        className="input"
                        value={selectedParkedCar.recordID}
                        onChange={(e) =>
                    ...
                    <TableCell>
                      <TextField
                        type="text"
                        className="input"
                        value={selectedParkedCar.parkinglotID}
                        onChange={(e) =>
                          setSelectedParkedCar({
                            ...selectedParkedCar,
                            parkinglotID: e.target.value,
                    ...
                    <TableCell>
                      <TextField
                        type="text"
                        className="input"
                        value={selectedParkedCar.timeEntered}
                        onChange={(e) =>
                          setSelectedParkedCar({
                            ...selectedParkedCar,
                            timeEntered: e.target.value,
                          })
                        }
                      />
                    </TableCell>
                    <TableCell>
                      <TextField
                        type="text"
                        className="input"
                        value={selectedParkedCar.timeExited}
                        onChange={(e) =>
                          setSelectedParkedCar({
                            ...selectedParkedCar,
                            timeExited: e.target.value,
                          })
                        }
                      />
                    </TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        type="text"
                        className="input"
                        value={selectedNotification.userID}
                        onChange={(e) =>
                          setSelectedNotification({
                            ...selectedNotification,
                            userID: e.target.value,
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        type="text"
                        className="input"
                        value={selectedTag.effectiveDate}
                        onChange={(e) =>
                          setSelectedTag({
                            ...selectedTag,
                    ...
                    <TableCell>
                      <TextField
                        type="text"
                        className="input"
                        value={selectedTag.expirationDate}
                        onChange={(e) =>
                          setSelectedTag({
                            ...selectedTag,
